...
class NotificationHelper{
  ...
  Future<void> showNotification(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin, ArticlesResult articles) async {
    var _channelId = "01";
    var _channelName = "channel_01";
    var _channelDesc = "dicoding news channel";
