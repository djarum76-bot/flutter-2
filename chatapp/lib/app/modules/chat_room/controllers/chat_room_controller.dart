...
class ChatRoomController extends GetxController {
  ...
  void deleteEmoji(){
    if(chatC.text.isAlphabetOnly || chatC.text.isNumericOnly){
      chatC.text = chatC.text.substring(0,chatC.text.length - 1);
    }else{
  ...
  void newChat(String email, Map<String, dynamic> argument, String chat)async{
    if(chat != ""){
      ...
      Timer(Duration.zero, ()=>scrollC.jumpTo(scrollC.position.maxScrollExtent));
      chatC.clear();
