...
class AuthController extends GetxController {
  ...
  Future<void> login() async {
    try {
      ...
      if(isSignIn){
        ...
        //simpan status user bahwa user sudah pernah login dan tidak akan menampilkan halaman introduction lagi
        final box = GetStorage();
  ...
  void changeProfile(String name, String status){
    ...
    Get.defaultDialog(
      title: "Sukses",
      middleText: "Profil berhasul diubah"
    );
  }
  ...
  void updatePhotoUrl(String url)async{
    ...
    Get.defaultDialog(
        title: "Sukses",
        middleText: "Berhasil update photo"
    );
  }
